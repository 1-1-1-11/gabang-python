...
| Task 12: 全新前端接入游戏 API | `task/12-new-frontend-game-api` | `.worktrees/12-new-frontend-game-api` | 已实现待审查 | `45ddb2f` | `docs/collaboration/reviews/12-new-frontend-game-api.md` | 未合并 |
